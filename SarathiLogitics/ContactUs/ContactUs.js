...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (nameInput) {
        addInputValidation(nameInput, (value) => value.trim().length >= 2, 'Name must be at least 2 characters long');
    }
    
    if (emailInput) {
        addInputValidation(emailInput, validateEmail, 'Please enter a valid email address');
    }
    
    if (phoneInput) {
        addInputValidation(phoneInput, validatePhone, 'Please enter a valid Nepali phone number');
    ...
    [submitBtn, bookNowBtn, ...document.querySelectorAll('.newsletter-btn')].forEach(btn => {
    ...
    // Initialize page
    console.log('Sarathi Logistics Contact Page - JavaScript Loaded Successfully');
